...
class CustomUserManager(BaseUserManager):
    """ A custom manager deals with email as unique identifer"""
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    is_active = models.BooleanField(
        ...
        default=True, 
        help_text=ugettext_lazy('Designates whether this user should be treated  as active.Unselect this instead of deleting accouts')
    )
...
class Profile(models.Model):
    ...
    username = models.CharField(max_length=263, blank=True, )
